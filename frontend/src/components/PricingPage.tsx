...
const FEATURES: FeatureDef[] = [
  ...
  { label: 'Saved attempts',         visitor: CROSS,       registered: '1 per exam',           paid: 'Unlimited' },
  ...
  { label: 'CSV / PDF export',       visitor: CROSS,       registered: CROSS,                  paid: CHECK },
  { label: 'Leaderboard',            visitor: CROSS,       registered: CROSS,                  paid: CHECK },
  { label: 'Gamification & badges',  visitor: CROSS,       registered: CHECK,                  paid: CHECK },
